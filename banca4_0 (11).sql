...
(19, 1192719887, 1, '2022-09-19', 1, 'Cristian', 'Andres', 'Castaño', 'Salas', 1, 'Palmira', '2022-09-12', '2022-09-06', 'Florida', 2, 1, 1, 'Ninguno', 'Calle 47', 13, 22, 'Poblado Comfaunion', 'Palmira', 'Valle', 'Colombia', 3172527139, 3172527140, 'cristian.0713.cs@gmail.com', 'Estudiante', 4, 'Ninguno', 4333, 3, 'Cristianx2', 'Calle 47', 'Poblado', 'Palmira', 'Valle', 'Colombia', 342323323, 32, 323, 'cristian@gmail.com', 200000000, 20000, 'ninguno', 200000, 200000, 2000, 20000000, '2022-09-19', 'Si', 'Si', 1, 'Si', 4352345, 'Euu', 'Canada', 34234, 5462, 'Palmira', 'Colombia', 'Palmira', 'Si', 2, 'Ninguno', 'Cristianx3', 1, 'Ninguno', 52342, 30000, 'Dolar', 'Palmira', 'Colombia', 2, 75074275, 31628274);
...
(8, 12345678, 1, 'Ester', 'Julia', 'Castaño', 'Loaiza', 'Directora', 'calle 59', 'Poblado', 'Palmira', 'Valle', 'Colombia', 453453, 54, 5435434, 'Ester@gmail.com');
...
(9, '2022-09-07', 1, 'Nit', 3152787667, 'Fideicomiso', 12345, 'Jose', 'Paisa', '2022-09-05', 'Palmira', 'Colombia', 'Calle 56', 'Poblado Comfaunion', 'Palmira', 'Valle', 'Colombia', 131313413, 343, 'jose@gmail.com', 3172527140, 'Si', 'Si', 12345678, 1, 355235, 'Ninguna', 34, 2, 'Ninguna', 2, 'Ninguna', 1, 'Ninguna', 2, 34534, 543534, 'Ninguna', 435435, '2022-09-20', 32424, 32423, 432424, 3342342, 4234232, 1, 1, 'Si', 'Si', 'Si', 'Si', 'Si', 345353, 'EUU', 'Canada', 4535, 75464, 1, 'Ninguna', 1, 'Ninguna', 'Colombia', 'Palmira', 'Si', 'Si', 1, 'Ninguna', 'Cristian', 1, 'Ninguna', 43535, 5346346, 'Dolar', 'New york', 'EUU', 1, 436353, 6789065);
...
CREATE TABLE `reg_soli` (
  ...
  `id_soli` int DEFAULT NULL COMMENT 'Identificacion de solicitud'
...
CREATE TABLE `reg_solij` (
  ...
  `Id_solij` int NOT NULL COMMENT 'Identificacion de la solicitud de pj'
...
(9, 3172527140, 1, 'Jhon', 'Carlos', 'Cervera', 'Beltran', 'Jefe', 'Calle 58', 'Poblado', 'Palmira', 'Valle', 'Colombia', 435435, 54, 5353453, 'Jhon@gmail.com');
...
(19, 1, 75074275, 'Cristian Andres', 'Cristianx5'),
(20, 1, 436353, 'Katherine Cervera', 'Katherine');
...
(19, 31628274, 'Sonia', 'Salas', 'Ninguna', 'Sonia'),
(20, 6789065, 'Sandra', 'Palm', 'Ninguna', 'Sandra');
...
--
ALTER TABLE `client_co`
  MODIFY `Id_client` int NOT NULL AUTO_INCREMENT COMMENT 'Identificacion aleatorio de cada cliente', AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `cont_ent`
--
ALTER TABLE `cont_ent`
  MODIFY `idcont_ent` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `entidad`
--
ALTER TABLE `entidad`
  MODIFY `Id_ent` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `est_soli`
--
ALTER TABLE `est_soli`
  MODIFY `Idest_soli` int NOT NULL AUTO_INCREMENT COMMENT 'Identificacion de estado de la solicitud', AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de la tabla `est_solij`
--
ALTER TABLE `est_solij`
  MODIFY `Idest_solij` int NOT NULL AUTO_INCREMENT COMMENT 'Identificacion de estado de la solicitud de persona juridica', AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de la tabla `reg_soli`
--
ALTER TABLE `reg_soli`
  MODIFY `Id_reg` int NOT NULL AUTO_INCREMENT COMMENT 'Identificacion de los registros de las solicitudes', AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT de la tabla `reg_solij`
--
ALTER TABLE `reg_solij`
  MODIFY `Id_regj` int NOT NULL AUTO_INCREMENT COMMENT 'Identificacion de los registros de las solicitudes', AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `reg_usu`
--
ALTER TABLE `reg_usu`
  MODIFY `Id_usu` int NOT NULL AUTO_INCREMENT COMMENT 'Identificacion de usuario', AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT de la tabla `repr_le`
--
ALTER TABLE `repr_le`
  MODIFY `idrepre` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `solicitante`
--
ALTER TABLE `solicitante`
  MODIFY `idsolicit` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de la tabla `vendedor`
--
ALTER TABLE `vendedor`
  MODIFY `idcond` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `reg_soli`
  ADD CONSTRAINT `reg_soli_ibfk_1` FOREIGN KEY (`id_soli`) REFERENCES `client_co` (`Id_client`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `reg_solij`
--
ALTER TABLE `reg_solij`
  ADD CONSTRAINT `reg_solij_ibfk_1` FOREIGN KEY (`Id_solij`) REFERENCES `entidad` (`Id_ent`) ON DELETE CASCADE ON UPDATE CASCADE;
